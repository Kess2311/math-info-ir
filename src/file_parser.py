...
def make_indices():
    ...
    for subdir, dirs, file_names in os.walk('../data/'):
        ...
        for file_name in tqdm(file_names):
            if file_name.endswith('.html'):
                with open(f'{subdir}/{file_name}', 'r', encoding='utf-8') as html_file:
                    ...
                    file_identifier = f'{directory}_{offset}'
                    ...
                    doc_dict[f'{directory}//{file_name}'] = [offset, doc_length]
                    total_docs += 1
    ...
    with open(f'../index/doc_info.idx', 'w+', encoding='utf-8') as doc_file:
        ...
        for doc_file_name, count in doc_dict.items():
            ...
            unique_rework = doc_file_name.split("//")
            doc_file.write(f'{unique_rework[1]}\t{unique_rework[0]}_{count[0]}\t{count[1]}\n')
